...
st.write("Halo! Ini adalah aplikasi Streamlit.")

pilihan_kendaraan = st.selectbox("Pilih jenis kendaraan:", ["Mobil", "Motor", "Sepeda"])
tahun = st.slider("Pilih tahun kendaraan:", 1990, 2026, 2020)
jarak_tempuh = st.number_input("Masukkan jarak tempuh kendaraan (km):", min_value=0)
kondisi = st.selectbox("Pilih kondisi kendaraan:", ["Baru", "Bekas", "Rusak"])
merk = st.text_input("Masukkan merk kendaraan:")

if st.button("Prediksi Harga"):
    # Di sini Anda bisa menambahkan logika untuk memprediksi harga berdasarkan input pengguna
    st.write(f"Prediksi harga untuk {pilihan_kendaraan} {merk} tahun {tahun} dengan jarak tempuh {jarak_tempuh} km dan kondisi {kondisi} adalah: [Hasil Prediksi]")
